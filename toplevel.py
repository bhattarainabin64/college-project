...
#>>>>>>>>>>>>>>>>>>ALL BUTTON OF MAIN WINDOW<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<$#
        ...
        self.button4 = Button(self.project, text="file", command=self.filehandling, width=10, height=1, bg="gray", fg="blue",font=("times new roman", 15))
        self.button4.place(x=180, y=700)
...
#>>>>>>>>>>>>>>>>>>>>>>>>>SEARCH FUNCTION OF MAIN WINDOW<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<$#
    ...
    def filehandling(self):
         file = open("Student_Record", "w")
         file.write("\n first Name: ")
         file.write(self.hand1 + "\n")
         file.write("last name: ")
         file.write(self.hand2 + "\n")
         file.write("Student ID: ")
         file.write(self.hand3 + "\n")
         file.write("Class: ")
         file.write(self.hand4 + "\n")
         file.write("average: ")
         file.write(self.hand5 + "\n")
         file.write("grade: ")
         file.write(self.hand6 + "\n")
         file.write("ranking: ")
         file.write(self.hand7 + "\n")
         file.write("Exam no: ")
         file.write(self.hand8 + "\n")
         file.write("mathematices: ")
         file.write(self.hand9 + "\n")
         file.write("English: ")
         file.write(self.hand10 + "\n")
         file.write("Science: ")
         file.write(self.hand11 + "\n")
         file.write("Social: ")
         file.write(self.hand12 + "\n")
         file.write("Computer: ")
         file.write(self.hand13 + "\n")
         file.write("Nepali: ")
         file.write(self.hand14 + "\n")
         file.write("Account: ")
         file.write(self.hand15 + "\n")
         file.write("Add math: ")
         file.write(self.hand16 + "\n")
         file.close()
         self.hand1=self.entry1.get()
         self.hand2 = self.entry2.get()
         self.hand3 = self.entry3.get()
         self.hand4 = self.entry4.get()
         self.hand5 = self.entry5.get()
         self.hand6 = self.entry6.get()
         self.hand7 = self.entry7.get()
         self.hand8 = self.entry8.get()
         self.hand9 = self.entry9.get()
         self.hand10 = self.entry10.get()
         self.hand11 = self.entry11.get()
         self.hand12 = self.entry12.get()
         self.hand13 = self.entry13.get()
         self.hand14 = self.entry14.get()
         self.hand15 = self.entry15.get()
         self.hand16 = self.entry16.get()
